# ----- functions for computing tail probabilities of truncated normal and truncated chi-squared distributions -----
# ----- full credit to Shuxiao Chen, the writer of the outference package  -----
# ----- Part 1: Truncated Normal Distribution -----
